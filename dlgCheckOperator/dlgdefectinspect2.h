#ifndef DLGDEFECTINSPECT2_H
#define DLGDEFECTINSPECT2_H
...
namespace Ui {
class DlgDefectInspect2;
}

class DlgDefectInspect2 : public QDialog
{
    Q_OBJECT

public:
    explicit DlgDefectInspect2(CheckOperatorDefectInspect2* const pCheckOperator,ImgPro* imgPro,OpencvImage & image,int basis_x=0,int basis_y=0,int mode=0,QWidget *parent = nullptr);
