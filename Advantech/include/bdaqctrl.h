...
BDAQINL int32             FmChannel_getTimeup(FmChannel *obj)                                                                           { return DAQFN_TV(DNLAPI_CNTR, 226, int32)(obj);                  }
BDAQINL ErrorCode         FmChannel_setTimeup(FmChannel *obj, int32 value)                                                              { return DAQFN_ET(DNLAPI_CNTR, 227, int32)(obj, value);           }
...
public:
   ...
   int32             getTimeup()                          { return FmChannel_getTimeup(this);                  }
   ErrorCode         setTimeup(int32 value)               { return FmChannel_setTimeup(this, value);           }
